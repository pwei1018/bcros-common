...
from notify_delivery.resources.gc_notify_housing import bp, process_message, worker
...
class TestGCNotifyHousingResource(unittest.TestCase):
    ...
    @patch("notify_delivery.resources.gc_notify_housing.queue")
    ...
    @patch("notify_delivery.resources.gc_notify_housing.queue")
    @patch("notify_delivery.resources.gc_notify_housing.process_message")
    @patch("notify_delivery.resources.gc_notify_housing.logger")
    def test_worker_valid_housing_event(self, mock_logger, mock_process, mock_queue):
    ...
    @patch("notify_delivery.resources.gc_notify_housing.Notification")
    @patch("notify_delivery.resources.gc_notify_housing.GCNotifyHousing")
    @patch("notify_delivery.resources.gc_notify_housing.NotificationHistory")
