...
"""Worker resource to handle incoming queue pushes from gcp for BC Notify."""
...
# Constants
EXPECTED_EVENT_TYPE = "bc.registry.notify.bc_notify"
...
def worker():
    ...
    try:
        ...
        process_notification(cloud_event.data, BCNotify)
