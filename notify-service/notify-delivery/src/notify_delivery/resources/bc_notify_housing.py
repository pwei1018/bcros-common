...
"""Worker resource to handle incoming queue pushes from gcp for BC Notify Housing."""
...
# Constants
EXPECTED_EVENT_TYPE = "bc.registry.notify.bc_notify_housing"
...
def worker():
    ...
    try:
        ...
        process_notification(cloud_event.data, BCNotifyHousing)
