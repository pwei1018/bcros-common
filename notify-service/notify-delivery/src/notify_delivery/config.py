...
from notify_delivery.utils.util import env_truthy
...
class Config:
    ...
    DB_POOL_RECYCLE = int(os.getenv("DATABASE_POOL_RECYCLE", "300"))
    ...
    if DEPLOYMENT_PLATFORM == "OCP":
        ...
        # BC Notify
        BC_NOTIFY_API_URL = os.getenv("BC_NOTIFY_API_URL", "")
        BC_NOTIFY_API_KEY = os.getenv("BC_NOTIFY_API_KEY", "")
        BC_NOTIFY_API_CLIENT_ID = os.getenv("BC_NOTIFY_API_CLIENT_ID", "")
        ...
        BC_NOTIFY_HOUSING_API_CLIENT_ID = os.getenv("BC_NOTIFY_HOUSING_API_CLIENT_ID", "")
