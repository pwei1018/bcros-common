...
class TestNotificationHistoryModel:
    ...
    def test_history_temporal_operations(self):
    ...
    def test_notification_history_model_creation(self):
    ...
    def test_notification_history_json_property(self, sample_history):
    ...
    def test_notification_history_json_property_with_none_values(self):
    ...
    def test_create_history_success(self, sample_notification):
    ...
    def test_create_history_default_recipient(self, sample_notification):
    ...
    def test_create_history_no_response_id(self, sample_notification):
    ...
    def test_create_history_uppercase_conversion(self, sample_notification):
    ...
    def test_find_by_response_id_found(self):
    ...
    def test_find_by_response_id_not_found(self):
    ...
    def test_find_by_response_id_none_input(self):
    ...
    def test_find_by_response_id_empty_string(self):
    ...
    def test_update_method(self, sample_history):
    ...
    def test_update_method_with_changes(self):
    ...
    def test_content_subject_access(self, sample_notification):
