...
class TestSafeListModel:
    ...
    def test_safe_list_email_validation_comprehensive(self, email, expected_valid):
    ...
    def test_safe_list_json_property_none_values(self):
    ...
    def test_safe_list_add_email_success(self):
    ...
    def test_safe_list_add_email_exception_handling(self):
    ...
    def test_safe_list_delete_email(self):
