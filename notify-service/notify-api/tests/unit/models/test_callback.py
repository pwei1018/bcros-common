...
class TestCallbackRequest:
    ...
    def test_callback_request_creation_with_all_fields(self):
    ...
    def test_callback_request_creation_with_minimal_fields(self):
    ...
    def test_callback_request_with_partial_data(self):
...
class TestCallback:
    ...
    @pytest.fixture
    def sample_callback_request(self):
    ...
    def test_callback_model_creation(self, sample_callback_request):
    ...
    def test_callback_save_success(self, sample_callback_request):
    ...
    def test_callback_save_with_exception(self, sample_callback_request):
    ...
    def test_callback_save_with_minimal_request(self):
    ...
    def test_callback_save_creates_correct_db_object(self, sample_callback_request):
    ...
    def test_callback_save_with_none_values(self):
