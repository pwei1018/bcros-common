...
class TestAlembicSetup:
    ...
    @pytest.fixture
    def script_directory(self, alembic_config):
    ...
    def test_no_branches_in_versions(self, script_directory):
    ...
    def test_migration_heads_are_consistent(self, script_directory):
    ...
    def test_all_migration_files_are_valid(self):
    ...
    def test_migration_file_naming_convention(self):
        ...
        for migration_file in migration_files:
            ...
            assert any(
                [
                    filename.startswith(tuple("0123456789")),  # Numbered migrations
    ...
    def test_env_py_exists_and_is_valid(self):
