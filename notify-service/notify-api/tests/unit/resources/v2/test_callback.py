...
class TestCallbackEndpoint:
    ...
    def test_gc_notify_callback_role(self, client, jwt):
    ...
    def test_callback_request_creation(self):
    ...
    def test_callback_request_with_none_values(self):
    ...
    def test_callback_request_partial_data(self):
    ...
    def test_callback_save_success(self, mock_db):
    ...
    @patch("notify_api.models.callback.db")
    def test_callback_save_with_exception(self, mock_db):
    ...
    @patch("notify_api.models.callback.db")
    def test_callback_save_with_none_values(self, mock_db):
    ...
    def test_callback_json_property(self):
    ...
    def test_callback_json_property_with_none_values(self):
    ...
    def test_find_notification_history_found(self, mock_find):
    ...
    @patch("notify_api.models.notification_history.NotificationHistory.find_by_response_id")
    def test_find_notification_history_not_found(self, mock_find):
    ...
    def test_notification_history_status_update(self):
    ...
    def test_callback_status_values(self):
    ...
    def test_callback_notification_types(self):
    ...
    def test_callback_with_long_strings(self):
    ...
    def test_empty_string_values(self):
        ...
        assert callback_request.id == ""
        assert callback_request.reference == ""
        assert callback_request.to == ""
        assert callback_request.status == ""
        assert callback_request.status_description == ""
        assert callback_request.provider_response == ""
        assert callback_request.notification_type == ""
    ...
    @patch("notify_api.models.callback.Callback.save")
    @patch("notify_api.models.notification_history.NotificationHistory.find_by_response_id")
    def test_complete_callback_flow_with_history_update(self, mock_find, mock_save):
    ...
    @patch("notify_api.models.callback.Callback.save")
    @patch("notify_api.models.notification_history.NotificationHistory.find_by_response_id")
    def test_complete_callback_flow_without_history(self, mock_find, mock_save):
    ...
    def test_callback_exception_handling_broad_except(self, client, jwt):
    ...
    def test_callback_notification_history_not_found(self, client, jwt):
    ...
    def test_callback_sys_exc_info_usage(self, client, jwt):
