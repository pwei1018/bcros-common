...
class TestSafeListAuthentication:
    ...
    @pytest.mark.parametrize("role", [Role.INVALID.value, Role.PUBLIC_USER.value, Role.JOB.value])
    def test_unauthorized_roles_post(self, client, jwt, role):
    ...
    @pytest.mark.parametrize("role", [Role.INVALID.value, Role.PUBLIC_USER.value, Role.JOB.value])
    def test_unauthorized_roles_delete(self, client, jwt, role):
    ...
    def test_authorized_roles_access(self, session, client, jwt, role):
...
class TestSafeListGet:
    ...
    def test_get_empty_safe_list(self, session, client, jwt):
    ...
    def test_get_safe_list_with_emails(self, session, client, jwt):
    ...
    def test_get_safe_list_response_structure(self, session, client, jwt):
    ...
    def test_get_safe_list_options_cors(self, client):
        """Assert that OPTIONS request for CORS works."""
        response = client.options("/api/v2/safe_list/")
        assert response.status_code == HTTPStatus.OK

    @pytest.mark.parametrize("method", ["PUT", "PATCH"])
    def test_get_safe_list_unsupported_methods(self, client, jwt, method):
    ...
    def test_get_safe_list_post_unsupported(self, client, jwt):
...
class TestSafeListPost:
    ...
    def test_add_single_email(self, session, client, jwt):
    ...
    def test_add_multiple_emails(self, session, client, jwt):
    ...
    def test_add_email_case_insensitive(self, session, client, jwt):
    ...
    def test_add_email_with_whitespace(self, session, client, jwt):
    ...
    def test_add_duplicate_email(self, session, client, jwt):
    ...
    def test_add_email_invalid_request_data(self, session, client, jwt, invalid_data):
    ...
    def test_add_email_problematic_data(self, session, client, jwt, problematic_data):
    ...
    def test_add_email_no_content_type(self, client, jwt):
    ...
    def test_add_email_database_error(self, session, client, jwt):
...
class TestSafeListDelete:
    ...
    def test_delete_existing_email(self, session, client, jwt):
    ...
    def test_delete_non_existing_email(self, session, client, jwt):
    ...
    def test_delete_email_case_sensitivity(self, session, client, jwt):
    ...
    def test_delete_email_with_special_characters(self, session, client, jwt):
    ...
    def test_delete_email_database_error(self, session, client, jwt):
        """Assert that database error handling encounters auth issues with current setup."""
    ...
    def test_delete_email_unsupported_methods(self, client, jwt, method):
        """Assert that unsupported HTTP methods return 405."""
        headers = create_header(jwt, [Role.STAFF.value], **{"Accept-Version": "v2"})
...
class TestSafeListIntegration:
    ...
    def test_full_crud_workflow(self, session, client, jwt):
    ...
    def test_concurrent_operations_simulation(self, session, client, jwt):
    ...
    def test_version_header_validation(self, session, client, jwt):
    ...
    def test_response_json_validity(self, session, client, jwt):
    ...
    def test_content_type_validation(self, session, client, jwt):
