...
from doc_legacy_migration.services.abstract_storage_service import DocumentTypes, StorageService
from doc_legacy_migration.services.gcp_auth.auth_service import GoogleAuthService
from doc_legacy_migration.services.utils.exceptions import StorageException
...
class GoogleStorageService(StorageService):  # pylint: disable=too-few-public-methods
    ...
    def init_app(config: Config):
        """Set up the service"""
        GoogleStorageService.GCP_BUCKET_ID_BUS = config.GCP_CS_BUCKET_ID_BUS
        GoogleStorageService.GCP_BUCKET_ID_MHR = config.GCP_CS_BUCKET_ID_MHR
        GoogleStorageService.GCP_BUCKET_ID_NR = config.GCP_CS_BUCKET_ID_NR
        GoogleStorageService.GCP_BUCKET_ID_PPR = config.GCP_CS_BUCKET_ID_PPR
