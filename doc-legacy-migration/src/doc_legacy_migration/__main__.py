...
from doc_legacy_migration.utils.logging import logger, setup_logging
...
if __name__ == "__main__":
    try:
        ...
        logger.info("Doc legacy migration job starting.")
        job(config)
        logger.info("Doc legacy migration job completed.")
