...
from colin_report_migration.utils.logging import logger, setup_logging
...
if __name__ == "__main__":
    try:
        ...
        logger.info(f"Colin report migration job {config.JOB_ID} starting.")
        job(config)
        logger.info(f"Colin report migration job {config.JOB_ID} completed.")
