...
def upgrade():
    ...
    sa.Column('document_class', postgresql.ENUM('COOP', 'CORP', 'FIRM', 'LP_LLP', 'MHR', 'NR', 'OTHER', 'PPR', 'SOCIETY', 'XP', name='documentclass'), nullable=False),
    ...
    op.bulk_insert(
        ...
        [
            ...
            {"document_class": "LP_LLP", "document_class_desc": "Limited Partnerships/Limited Liability Partnerships"},
            ...
            {"document_class": "XP", "document_class_desc": "Extraprovincial Registrations"},
        ],
    )
    op.bulk_insert(
        document_types,
        [
            ...
            {"document_type": "OTP", "document_class": "OTHER", "document_type_desc": "Other", "product": "business", "doc_id_required": False},
            {"document_type": "LP_LLP_MISC", "document_class": "LP_LLP", "document_type_desc": "LP/LLP miscellaneous documents", "product": "business", "doc_id_required": False},
            {"document_type": "XP_MISC", "document_class": "XP", "document_type_desc": "Extraprovincial miscellaneous documents", "product": "business", "doc_id_required": False},
        ],
    )
