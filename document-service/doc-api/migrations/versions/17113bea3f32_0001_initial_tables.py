...
def upgrade():
    ...
    op.bulk_insert(
        ...
        [
            ...
            {"document_type": "DELETED", "document_class": "DELETED", "document_type_desc": "Removed, marked as deleted.", "product": "*", "doc_id_required": False, "active": True, "application_id": "ALL"},
        ],
    )
