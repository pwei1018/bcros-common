...
bp = Blueprint("NAMEREQUEST1", __name__, url_prefix="/nro")  # pylint: disable=invalid-name
...
def post_name_request_docs(doc_type: str):  # pylint: disable=too-many-return-statements
    ...
    try:
        ...
        return resource_utils.db_exception_response(db_exception, account_id, "POST nr doc id=" + account_id)
