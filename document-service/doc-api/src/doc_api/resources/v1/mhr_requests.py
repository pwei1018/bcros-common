...
bp = Blueprint("MHREGISTRY1", __name__, url_prefix="/mhr")  # pylint: disable=invalid-name
...
def post_mhr_docs(doc_type: str):  # pylint: disable=too-many-return-statements
    ...
    try:
        ...
        return resource_utils.db_exception_response(db_exception, account_id, "POST MHR doc id=" + account_id)
