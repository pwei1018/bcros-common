...
bp = Blueprint('SCANNING1',  # pylint: disable=invalid-name
               __name__, url_prefix='/scanning')
...
def post_document_scanning(doc_class: str, consumer_doc_id: str):
    ...
    try:
        ...
        return resource_utils.db_exception_response(db_exception, account_id,
                                                    'POST create document scanning id=' + account_id)
...
def update_document_scanning(doc_class: str, consumer_doc_id: str):
    ...
    try:
        ...
        if not doc_scan:
            ...
            return resource_utils.not_found_error_response(f'PATCH document scanning class={doc_class}',
                                                           consumer_doc_id)
