...
bp = Blueprint("BUSINESS1", __name__, url_prefix="/business")  # pylint: disable=invalid-name
...
def post_business_docs(doc_class: str, doc_type: str):  # pylint: disable=too-many-return-statements
    ...
    try:
        ...
        return resource_utils.db_exception_response(db_exception, account_id, "POST business doc id=" + account_id)
