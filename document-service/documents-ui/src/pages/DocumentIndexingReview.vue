      ...
      <BcrosSection name="documentIndexingReview">
        <template #header>
          <div class="grid grid-cols-6">
            <div class="col-span-6">
              <h1 class="text-[32px] pb-2">
                {{ $t("documentIndexing.reviewLabel") }}
              </h1>
              <span class="text-gray-700 font-normal text-base">{{
                $t("documentIndexing.reviewSubtitle")
              }}</span>
            </div>
          </div>
        </template>
                ...
                <div class="grid grid-flow-row auto-rows-max">
                  <div class="py-1 grid grid-cols-3">
                    <span class="font-bold text-gray-900">{{
                      $t("documentIndexing.label")
                    }}</span>
                  </div>
                  <div class="py-1 grid grid-cols-3">
                    <span class="font-bold text-gray-900">{{
                      $t("documentReview.labels.documentId")
                    }}</span>
                    <span class="px-1 col-span-2">
                      {{
                        consumerDocumentId ||
                        "Will be automatically generated when the document record is saved"
                      }}
                    </span>
                  </div>
                  <div class="py-1 grid grid-cols-3">
                    ...
                    <span class="px-1 col-span-2">{{
                      consumerIdentifier || "Not Entered"
                    }}</span>
                  </div>
                  <div class="py-1 grid grid-cols-3">
                    <span class="font-bold text-gray-900">{{
                    ...
                    <span class="px-1 col-span-2">{{
                      getDocumentDescription(documentClass)
                    }}</span>
                  </div>
                  <div class="py-1 grid grid-cols-3">
                    <span class="font-bold text-gray-900">{{
                    ...
                    <span class="px-1 col-span-2">{{
                      getDocumentDescription(documentType, true)
                    }}</span>
                  </div>
                  <div class="py-1 grid grid-cols-3">
                    <span class="font-bold text-gray-900">{{
